...
int __no_inline_not_in_flash_func(opusGetNextFrame)(OpusDecoder * decoder, int16_t * buffer, int opusID) {
  ...
  int decSize = opus_decode(decoder, frame, size, buffer, OPUS_FRAMESAMPLES[opusID], 0);
...
OpusDecoder * decoder;
int16_t opusFetchBuffer[OPUS_SAMPLERATE / 1000 * 120 * 2]; // 120 ms is maximum possible framesize
